                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="widget widget-company">
                            <a href="index.html"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon/logo.png" alt="image"></a>
                            <div class="address">
                                <h6>Office Address</h6>
                                <p>Paldi Village, Near Jarod, Gujarat </p>
                            </div>
                            <div class="address">
    ...
    <script src="<?php echo get_template_directory_uri(); ?>/assets/js/vendor/jquery-2.2.4.min.js"></script>
    <!-- bootstrap 4 js -->
