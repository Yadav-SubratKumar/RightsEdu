                ...
                <div class="col-lg-8 col-md-8">
                    <div class="course-details">
                        <div class="cs-thumb mb-5">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/course/course-details.jpg" alt="image">
                        ...
                        <div class="cs-content"> 
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="cs-share-right">
                                            ...
                                            <div class="cs-post-author">By <span>Sajib</span></div>
                                            <div class="cs-comments">45 COMMENT</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="post-author-info">
                                <div class="thumb">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/author/cs-post-author1.jpg" alt="image">
                                </div>
                                <div class="fix">
                                    <h4>Rebeka</h4>
                    ...
                    <div class="comment-area">
                        ...
                        <ul class="comment-list">
                            <li class="comment-info-inner">
                                <article>
                                    <div class="comment-thumb">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/author/cs-comment-auth1.jpg" alt="image">
                                    </div>
                                ...
                                <ul class="children">
                                    <li class="comment-info-inner">
                                        <article>
                                            <div class="comment-thumb">
                                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/author/cs-comment-auth2.jpg" alt="image">
                                            </div>
                                            <div class="comment-content">
                                                <h4>John doe</h4>
                                                <p>Ed id interdum urna. Nam ac elit a ante commodo tristique. Duis lacus urna, condimentum a vehicula a, hendrerit ac nisi Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
                            ...
                            <li class="comment-info-inner">
                                <article>
                                    <div class="comment-thumb">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/author/cs-comment-auth3.jpg" alt="image">
                                    </div>
                                    <div class="comment-content">
                                        <h4>Bagun khan</h4>
                                        <p>Ed id interdum urna. Nam ac elit a ante commodo tristique. Duis lacus urna, condimentum a vehicula a, hendrerit ac nisi Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
                        ...
                        <div class="widget widget-course">
                            ...
                            <div class="course-list">
                                <div class="w-cs-single">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/course/cs-small-thumb1.jpg" alt="image">
                                    <div class="fix">
                                ...
                                <div class="w-cs-single">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/course/cs-small-thumb2.jpg" alt="image">
                                    <div class="fix">
                                ...
                                <div class="w-cs-single">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/course/cs-small-thumb3.jpg" alt="image">
                                    <div class="fix">
                                        <p><a href="#">C++</a></p>
                                        <span><i class="fa fa-clock-o"></i> AUGUST 6, 2017</span>
                                    </div>
                                ...
                                <div class="w-cs-single">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/course/cs-small-thumb4.jpg" alt="image">
                                    <div class="fix">
                                        <p><a href="#">Seo</a></p>
                                        <span><i class="fa fa-clock-o"></i> AUGUST 6, 2017</span>
                                    </div>
                                ...
                                <div class="w-cs-single">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/course/cs-small-thumb5.jpg" alt="image">
                                    <div class="fix">
                                        <p><a href="#">Python</a></p>
                                        <span><i class="fa fa-clock-o"></i> AUGUST 6, 2017</span>
                                    </div>
